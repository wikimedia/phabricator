...
$args->setTagline(pht('Transform a project into either a subproject or milestone of another project.'));
$synopsis = <<<EOT
./bin/move_project <fg:black>(</fg>**--subproject** <fg:black>|</fg> **--milestone**<fg:black>)</fg> --parent **ParentHashtag** --child **ChildHashtag** --keep-members **parent**|**child**|**both**

See __https://secure.phabricator.com/T10350__ for more details.

EOT;

$args->setSynopsis(pht($synopsis));
